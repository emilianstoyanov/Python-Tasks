...
# Example
    ...
    # The third candidate can win even if none of the remaining candidates vote for him. For example, if each of
    # the remaining voters cast their votes for each of his opponents, he will still be the winner
